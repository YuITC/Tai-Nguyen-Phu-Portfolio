      ...
      <div className="space-y-5">
        <div className="glass p-6">
          ...
          <ul className="text-sm space-y-1 text-slate-300">
            ...
            <li><span className="text-slate-400">LinkedIn:</span> <a href="https://www.linkedin.com/in/taingph2502/" className="underline decoration-dotted hover:text-fuchsia-200">linkedin.com/in/taingph2502</a></li>
            ...
            <li><span className="text-slate-400">Facebook:</span> <a href="https://www.facebook.com/taingph2502/" className="underline decoration-dotted hover:text-fuchsia-200">facebook.com/taingph2502</a></li>
          </ul>
        </div>
      </div>
    </div>
