                ...
                <SectionWrapper id="home" className="min-h-[70vh] flex flex-col justify-center">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6 animate-fade-in">
                            ...
                            <div>
                                <a href="/src/assets/resumes/resume.pdf" className="inline-block px-6 py-2 rounded-md bg-gradient-to-r from-fuchsia-600 to-indigo-600 hover:from-fuchsia-500 hover:to-indigo-500 font-medium">
                                    View my Resume
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="w-80 h-80 mx-auto rounded-3xl bg-gradient-to-br from-fuchsia-500/30 to-indigo-500/30 border border-white/10 backdrop-blur-md flex items-center justify-center text-slate-300 text-xl font-medium shadow-xl shadow-black/50">
                                <img src="/src/assets/me.png" alt="Portrait of Tai Nguyen Phu" className="w-full h-full object-cover rounded-3xl" />
                            </div>
                        </div>
                    </div>
                </SectionWrapper>
