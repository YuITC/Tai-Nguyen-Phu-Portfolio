import { SocialActivityEntry } from "@/types";

export const socialActivityEntries: SocialActivityEntry[] = [
  {
    title: "Green Summer Volunteer Campaign of UIT Students' Union",
    role: "Member",
  ...
  {
    title: "Study Board of Software Engineering",
    role: "English Team Member",
