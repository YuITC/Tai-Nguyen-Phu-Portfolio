export const PINNED_REPOS = ["Meta-RAG", "novel-verse-ai", "Vietnamese-Legal-Doc-Retrieval", "Dense-Passage-Retrieval"];

export const CATEGORIES = ["All", "NLP", "LLM", "RAG", "Agentic AI", "Computer Vision", "Machine Learning", "Generative AI", "Deep Learning", "Research"] as const;
