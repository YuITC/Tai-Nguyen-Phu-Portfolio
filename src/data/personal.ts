...
export const socialLinks: SocialLink[] = [
  ...
  { name: "LinkedIn", url: "https://www.linkedin.com/in/yuitc/", icon: "linkedin" },
  { name: "Facebook", url: "https://www.facebook.com/taing2502/", icon: "facebook" },
  { name: "HuggingFace", url: "https://huggingface.co/YuITC", icon: "huggingface" },
